...
Renderbuffer::Renderbuffer(const InternalImageFormat internalFormat, const GLsizei width, const GLsizei height) : Renderbuffer{}
...
Renderbuffer::Renderbuffer(Renderbuffer &&other) noexcept
  : m_id(std::exchange(other.m_id, 0)), m_internalFormat(other.m_internalFormat), m_width(other.m_width), m_height(other.m_height)
{}
